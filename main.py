...
location = geolocator.geocode('Kumaraswamy Layout, Bangalore, Karanataka')
bot = telepot.Bot('6157107098:AAE_-k_SkZVOTvW8tzkpJHXmZyiM-GbK6-k')
rec=1      
class IdData:
                ...
                if len(face_patches) > 0:
                    ...
                    for bb, landmark, matching_id, dist in zip(
                        ...
                        if matching_id is None:
                            ...
                            if count>5:
                                count=0
                                bot.sendMessage('1627990722',str("The Missing Person Identified is {0} at Kumaraswamy Layout, Bangalore, Karanataka ( Longitude:{1} Latitude{2})" .format(str(matching_id), location.latitude, location.longitude)))
                               # check_otp(matching_id)
                                break
